...
\item Use plated holes for any through-hole components. This is default in most PCB design sofware.
\item If it is reasonable, route traces so that if a solder joint on one component fails, it does not affect the surrounding components. This applies especially to power connections for independent parts of the circuit.
